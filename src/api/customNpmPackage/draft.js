 ...
 * callback({stream}) -  на вход коллбеку отправляем 
 */
...
const loadMore = ({internalStore, stream, sources, afterPost, limit, callback}) => {
    ...
    if(maxDepth < internalStore.archiveDepth) internalStore.archiveDepth = maxDepth;
