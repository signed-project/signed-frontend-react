...
const InfoAuthor = ({ name, createdAt, address, isShowDate = true, typePost, targetPostText, postHash, title, img }) => {
            ...
            <div className={styles.info}>
                <div className={styles.textWrapper} >
                    <div className={styles.nameBlock} >
                        <img src={icon.tickOne} alt="tick icon" className={styles.tickOne} onClick={() => {
                            history.push(`${routes.source}/${address}`);
                        }} />
                        <span className={styles.name} onClick={() => {
                            history.push(`${routes.source}/${address}`);
                        }}>{name}</span>
